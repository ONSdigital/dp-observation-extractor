job "dp-observation-extractor" {
  ...
  group "publishing" {
    ...
    task "dp-observation-extractor" {
      ...
      artifact {
        source = "s3::https://s3-eu-west-1.amazonaws.com/{{BUILD_BUCKET}}/dp-observation-extractor/{{REVISION}}.tar.gz"
      }

      artifact {
        source = "s3::https://s3-eu-west-1.amazonaws.com/{{DEPLOYMENT_BUCKET}}/dp-observation-extractor/{{REVISION}}.tar.gz"
      }
